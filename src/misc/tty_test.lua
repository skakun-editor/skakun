...
return function()
  ...
  tty.flush()
  while (tty.read_events()[1] or {}).button ~= 'enter' do
    tty.wait_for_read()
  end
  tty.write('\r\n')
  ...
  for i = 1, math.huge do
    ...
    for _, event in ipairs(events) do
      ...
      if event.button == 'q' and not event.alt and event.ctrl and not event.shift then return end
    end
